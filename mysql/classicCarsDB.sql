...
/*
 From exercises one:
 Find the employees who work for Mary Patterson, Gerard Bondur, or Anthony Bow. Display their employee numbers,
 first and last names, job title, email addresses and number of the employee they report to.
...
WHERE
  (m.firstName = 'Mary' AND m.lastName = 'Patterson')
  OR (m.firstName = 'Gerard' AND m.lastName = 'Bondur')
  OR (m.firstName = 'Anthony' AND m.lastName = 'Bow')
ORDER BY
  e.lastName,
  e.firstName;
